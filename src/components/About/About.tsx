            ...
            <div className="container">
                ...
                <div className="about-layout">
                    ...
                    <div className="about-text">
                        <p>
                            Привет! Меня зовут <strong>Елизавета Сиволобова</strong>, я живу в городе-герое Волгограде и мечтаю о сцене уже с тех пор,
                            как себя помню. Музыка и театр — это два мира, которые наполняют мою жизнь смыслом и радостью.
                        </p>

                        <p>
                            Я занимаюсь с 3 лет вокалом в студии музыки и вокала{' '}
                            <a
                                href="https://vk.ru/club221492758"
                                target="_blank"
                            ...
                            и одновременно посещаю актёрскую школу{' '}
                            <a
                                href="https://vk.ru/i_actor.volgograd"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="about-link"
                            >
                            ...
                            , педагог Анастасия Голубева. На сцене я чувствую настоящую свободу — каждый выход это маленькая жизнь, прожитая вместе со зрителями.
                        </p>
