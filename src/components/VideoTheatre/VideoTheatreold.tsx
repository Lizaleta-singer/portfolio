...
const videos: VideoItem[] = [
        { id: 1, url: 'https://vkvideo.ru/video-206140174_456240715?ysclid=mu9avk2d2p635871168', title: 'Актёрская визитка "Я-Актёр!"' },
         { id: 2, url: 'https://vkvideo.ru/video-206140174_456240689', title: 'Спектакль - Кто ограбил миссис Рэббит (реж. Е.Апакова)' },
          { id: 3, url: 'https://vkvideo.ru/video-206140174_456240420', title: 'Про Рок "По барабану"' },
]
                                                                                ...
                                                                                <div
                                                                                       className="video-play-area"
                                                                                           onClick={openVideoFrame}
                                                                                                   >
                                                                                                    <img
                                                                                                        src={`https://picsum.photos/800/450?random=${v.id + 30}`}
                                                                                                         alt=""
